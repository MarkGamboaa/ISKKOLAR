          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5">
                ...
                <span className="text-sm">937 Padre Paredes St, Sampaloc, Manila, 1008 Metro Manila</span>
              </li>
              <li className="flex items-center gap-2.5">
                ...
                <span className="text-sm">kkfi1950@gmail.com</span>
              </li>
              <li className="flex items-center gap-2.5">
                <svg className="w-4.5 h-4.5 shrink-0 text-primary-light" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
                <span className="text-sm">0920 280 7883</span>
              </li>
            </ul>
            {/* Social */}
            <div className="mt-4">
              <a
                href="https://www.facebook.com/kkfimissions"
                target="_blank"
