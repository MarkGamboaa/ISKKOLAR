...
const HomePage = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      title: "Board Exam Assistance",
      description: "Financial support for scholars preparing for professional licensure examinations.",
  ...
  const stats = [
    ...
    { value: "5,000+", label: "Scholars Supported" },
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Upload documents and track requirements online",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      description: "Monitor your application status anytime",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="hero" className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary-dark">
        {/* Background Pattern */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                Building Futures Through Education Since 1951
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                ...
                programs, we have helped thousands of students achieve their dreams and contribute
                to nation-building.
              </p>
            ...
            {/* Right - Image/Visual */}
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-br from-primary/20 to-amber-500/20 rounded-3xl blur-2xl" />
              <div className="relative bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                <div className="flex items-center gap-4 mb-6">
                  <img src={kkfiLogo} alt="KKFI" className="w-16 h-16 rounded-xl object-cover" />
                  <div>
                    <h3 className="font-bold text-gray-900">KKFI Mission</h3>
                    <p className="text-sm text-gray-500">Kapatiran-Kaunlaran Foundation</p>
                  </div>
                </div>
                <blockquote className="text-gray-700 italic border-l-4 border-primary pl-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-primary-light border-2 border-white" />
                    ))}
                  </div>
                  <span className="text-sm text-gray-600">Join 5,000+ scholars nationwide</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {programs.map((program, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300 hover:-translate-y-1"
              >
                <div className={`w-16 h-16 ${program.color} rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}>
                  {program.icon}
                </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary-dark relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Take the first step towards your educational goals. Apply for a KKFI scholarship today
            and join thousands of scholars who have transformed their lives through education.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate("/signup")}
              className="px-8 py-4 bg-white text-primary font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Start Application
            </button>
            <button
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Foundation St., Quezon City, Metro Manila, Philippines</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@kkfi.org</p>
                    <p className="text-gray-600">scholarships@kkfi.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+63 2 8888 1234</p>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-primary hover:text-white transition-colors">
                  ...
                  {[
                    {
                      ...
                      a: "Filipino students who meet the academic and financial requirements set by KKFI for each program.",
                    },
                    {
                      q: "When is the application period?",
                      a: "Applications are typically accepted from January to March each year. Check our announcements for specific dates.",
                    },
                    {
                      q: "What documents are required?",
                      a: "Requirements include grades, income documents, and recommendation letters. Specific requirements vary by program.",
                    },
                    {
                      q: "How long does the application process take?",
                      a: "The review process typically takes 4-6 weeks after the deadline. Applicants will be notified via email.",
                    },
                  ].map((faq, index) => (
