import ApplicantsTable from "../../components/dashboard/admin/ApplicantsTable";
import ApplicantDetailView from "../../components/dashboard/admin/ApplicantDetailView";
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 ml-[220px] p-[30px] min-h-screen bg-[#f8f9fc]">
        ...
        {activeTab === "applicants" && !viewApplicant && (
          <>
            <div className="flex items-center justify-between mb-6">
            ...
            <ApplicantsTable users={filteredApplicants} loading={loading} onView={setViewApplicant} />
          </>
        )}

        {activeTab === "applicants" && viewApplicant && (
          <ApplicantDetailView applicant={viewApplicant} onBack={() => setViewApplicant(null)} />
        )}
